...
Its primary initial purpose was to compare with the arduino project

ESP8266audio at https://github.com/earlephilhower/ESP8266Audio

This project is extremely good but I got the impression that the esp32 was not able to 

Developed using  the visual studio code IDE with the esp-idf extension installed
Added to the esp-idf extension is esp-adf, which is installed into the esp-idf extension using 'Install ESP-ADF'
